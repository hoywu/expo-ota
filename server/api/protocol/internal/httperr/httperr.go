// Package httperr defines the protocol API's error model: domain errors
// that carry an HTTP status code, and the global handler that maps any
// error to the unified JSON error response.
package httperr
...
// the unified JSON error body, and hides internal error details.
